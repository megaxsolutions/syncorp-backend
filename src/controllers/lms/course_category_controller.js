...
export const create_course_category = asyncHandler(async (req, res) => {
    ...
    try {
        ...
        const [insert_data_course_category] = await db.query(sql, [category_title, storeCurrentDateTime(0, 'hours')]);
...
export const update_course_category = asyncHandler(async (req, res) => {
    ...
    try {
        ...
        const [update_data_course_category] = await db.query(sql, [category_title, course_category_id]);
...
export const get_all_course_category = asyncHandler(async (req, res) => {
    try {
        ...
        const [course_category] = await db.query(sql);
...
export const delete_course_category = asyncHandler(async (req, res) => {
    ...
    try {
        ...
        const [result] = await db.query(sql, [course_category_id]);
