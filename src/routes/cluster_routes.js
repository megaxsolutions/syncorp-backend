...
import * as ClusterController  from '../controllers/cluster_controller.js'; // Adjust the path as necessary
...
clusterRoutes.post('/create', ClusterController.create_cluster);
