...
import * as AttendanceController  from '../../controllers/sync_db/attendance_controller.js'; // Adjust the path as necessary
...
attendanceRoutes.get('/get_all_attendance_live', AttendanceController.get_all_attendance_live);
attendanceRoutes.get('/get_all_attendance_supervisor/:supervisor_emp_id', AttendanceController.get_all_attendance_supervisor);
attendanceRoutes.get('/get_all_attendance_supervisor_live/:supervisor_emp_id', AttendanceController.get_all_attendance_supervisor_live);
