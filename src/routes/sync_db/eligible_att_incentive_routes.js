...
eligibleAttendanceIncentive.get('/get_all_eligible_att_incentive_employees_supervisor_cutoff/:supervisor_emp_id/:cutoff_id', EligibleAttendanceIncentiveController.get_all_eligible_att_incentive_employees_supervisor_cutoff);
